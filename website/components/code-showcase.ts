...
const ICONS = {
  ...
  tsFile: html`<svg class="w-4 h-4 text-[#3178c6] shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M1.37 0h21.26c.76 0 1.37.61 1.37 1.37v21.26c0 .76-.61 1.37-1.37 1.37H1.37C.61 24 0 23.39 0 22.63V1.37C0 .61.61 0 1.37 0zm19.1 19c.7 0 1-.26 1-1.07v-3.79c0-.85-.3-1.12-1.05-1.12-.66 0-.97.27-.97 1.12v3.79c0 .81.27 1.07 1.02 1.07zm-7.66 0c.93 0 1.3-.39 1.3-1.63v-6.27h-1.89v6.52c0 .35-.07.48-.37.48-.28 0-.39-.1-.39-.45v-6.55H9.56v6.3c0 1.25.4 1.6 1.25 1.6z"/></svg>`,
