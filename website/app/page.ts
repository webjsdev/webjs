...
export default function LandingPage() {
  return html`
    ...
    <section class="py-16 md:py-16" data-reveal>
...
lib/session.server.ts</pre>
    ...
    <section class="py-16 md:py-16 text-center" id="get-started" data-reveal>
      <div class="max-w-[1080px] mx-auto px-6">
    ...
    <footer class="mt-16 md:mt-16 border-t border-border py-12 px-6">
      ...
      <div class="w-full text-center mt-6 md:mt-0 text-fg-subtle text-[12.5px]">Built with webjs <svg class="heart" viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="love"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg></div>
    </footer>
