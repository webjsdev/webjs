...
export default function Components() {
  return html`
    ...
    <ul>
      <li><code>html\`…\`</code> and <code>css\`…\`</code> tagged-template literals — same shape, same hole semantics (<code>\${expr}</code> for text, <code>@event=\${fn}</code> for listeners, <code>.prop=\${value}</code> for properties, <code>?bool=\${value}</code> for boolean attributes). Lit's <a href="https://www.npmjs.com/package/ts-lit-plugin" target="_blank">ts-lit-plugin</a> works out of the box; <code>@webjskit/ts-plugin</code> layers webjs-aware tag and attribute intelligence on top of it (see <a href="/docs/editor-setup">Editor setup</a>).</li>
