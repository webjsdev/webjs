...
export default function SessionsExample() {
  return html`
    ...
    <p>GET <a class="text-primary" href="/features/sessions/count">/features/sessions/count</a> increments a per-visitor counter kept in the signed session cookie. Reload it and the count climbs; open it in a private window and it starts over.</p>
