    ...
    <section class="mb-12">
      ...
      <div class="mt-8 grid md:grid-cols-2 gap-4">
        <div class="border rounded-lg p-4">
          ...
          <pre class="text-xs bg-muted p-3 rounded overflow-x-auto"><code># included with @webjskit/cli
webjs ui init
webjs ui add button card dialog</code></pre>
        </div>
        <div class="border rounded-lg p-4">
          <div class="text-sm font-semibold mb-2">Next / Astro / Vite / Lit / anything else</div>
          <pre class="text-xs bg-muted p-3 rounded overflow-x-auto"><code>npm install -D @webjskit/ui
